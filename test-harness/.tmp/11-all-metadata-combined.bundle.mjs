...
// test-harness/11-all-metadata-combined.mjs
var failures = 0;
...
function groupByLevel(ous2) {
  const levels = /* @__PURE__ */ new Map();
  for (const ou of ous2) {
    const l = computeOULevel(ou, ous2);
...
var [ous, des, oss] = await Promise.all([
